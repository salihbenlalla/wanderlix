...
export default component$(() => {
  ...
  useVisibleTask$(({ track }) => {
    ...
    console.log("current section index: ", HomeContextStore.currentSectionIndex);
  ...
  return (
    <div class="container">
      <div class="sectoin2-content">
        <div ref={leftRef} class="sectoin2-content-left">
          <HeroCaption />
        </div>
        <div ref={rightRef} class="section2-content-right">
          <SlickSlider
