...
const cspDirectives = {
  ...
  "style-src": [
    "'self'",
    "'sha256-+Z6QOXS2XhgFeS+ks3nyYdx0D097V7HwlpRWZlOdo2Q='",
    "'sha256-JS++iFe6IB1NU6xdcilpieymTolymAATRKuWUxjHKpA='",
    "'sha256-qOH1QxZhn+0D5eXyUUnX/rWfXpvEtbv4EdYnKR3F4vI='",
    "'sha256-fY/sus+SsiaraaiAwyvOwBoq2CaFeYOs/zpX0+vg3BQ='",
    "'sha256-pq6logM8N7khTR0Z8nPOabqn444cld5r+a89yZJEd60='",
    "'sha256-FXo0KW0T1M5XziyJq72DdUYgV6s0bHglTXEQFQfuwfU='",
    "'sha256-sHJ+jmGGaHFCu17eb26+1azBbWxJ+0Q3QV0gMMcZ160='",
  ],
  "style-src-attr": ["'none'"],
  "img-src": ["'self'"],
  "font-src": ["'self'"],
